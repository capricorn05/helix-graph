...
export type InteractionsCompiledViewProps = Parameters<
  typeof import("../../views-tsx/interactions.view.js").default
>[0];
...
export const interactionsCompiledArtifact: CompiledViewArtifact<InteractionsCompiledViewProps> = defineCompiledViewArtifact<InteractionsCompiledViewProps>(
  compiledViewId("interactions"),
  "interactions",
  {
    ...
    patches: [
    {
      ...
      evaluate: (props: InteractionsCompiledViewProps) => (props.resetButtonHtml),
    }
    ],
...
export const interactionsCompiledViewId = interactionsCompiledArtifact.id;

export function renderInteractionsCompiledView(props: InteractionsCompiledViewProps): string {
