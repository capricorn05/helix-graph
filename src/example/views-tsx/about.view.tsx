...
export default function AboutPageView(_props: AboutPageProps) {
  return (
    <>
      <section>
      ...
      <section>
        ...
        <p>
          ...
          Graph router (<code>defineRoute</code>) compiles URL patterns,
          dispatches requests, coordinates resource reads and action invocations.
        </p>
        <p>
          <strong>Client-Side:</strong>{" "}
          SSR-embedded graph snapshot + binding map enable resumable
